...
#Output file
output_folder='hdfsrs/experiments/stephen/SharedFileLatencyData/'$total_clients'_'$rw_ratio'/'
...
do
	nohup hadoop jar hdfsrs/experiments/stephen/SharedFileLatencyExperiments/SharedFileLatency.jar run $requests_per_client 32 $rw_ratio &>> $output_folder'temp'$i&
done
