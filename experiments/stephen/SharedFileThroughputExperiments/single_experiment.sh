...
#Output file
output_filename='hdfsrs/experiments/stephen/SharedFileThroughputData/'$total_clients'_'$rw_ratio'.csv'
...
do
	nohup hadoop jar hdfsrs/experiments/stephen/SharedFileThroughputExperiments/SharedFileThroughput.jar run $requests_per_client 32 $rw_ratio &>> $output_filename&
done
