...
waitTimes=(200s 400s 800s 1000s 1000s)

cmd='sh hdfsrs/experiments/stephen/SharedFileThroughputExperiments/single_experiment.sh'
...
do
	 ...
	 do
		 ...
		 sh hdfsrs/experiments/stephen/SharedFileThroughputExperiments/reset.sh &> /dev/null
		 #Run on first node
