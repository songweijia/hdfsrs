...
#Output file
output_filename='hdfsrs/experiments/stephen/MultipleFileThroughputData/'$total_clients'_'$rw_ratio'/'
...
do
	nohup hadoop jar hdfsrs/experiments/stephen/MultipleFileThroughputExperiments/MultipleFileThroughput.jar run $requests_per_client 32 $rw_ratio '/node'$node_id'file'$i'.txt' &>> $output_folder'temp'$i&
done
