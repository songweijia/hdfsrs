...
do
	nohup hadoop jar hdfsrs/experiments/stephen/MultipleFileLatencyExperiments/MultipleFileLatency.jar run $requests_per_client 32 $rw_ratio '/node'$node_id'file'$i'.txt' &>> $output_folder'temp'$i&
done
